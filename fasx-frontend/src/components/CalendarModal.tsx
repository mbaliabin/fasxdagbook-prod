...
interface CalendarWebProps {
  ...
  anchorRef: React.RefObject<HTMLButtonElement>; // кнопка, к которой привязываем календарь
}
...
const CalendarWeb: React.FC<CalendarWebProps> = ({
  ...
  return (
    <div
      ref={containerRef}
      className="absolute z-50 bg-[#1c1c1e] text-gray-200 rounded-2xl shadow-lg p-4 w-80"
